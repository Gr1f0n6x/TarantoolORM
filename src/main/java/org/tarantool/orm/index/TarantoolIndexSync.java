...
final public class TarantoolIndexSync<T extends TarantoolTuple> extends TarantoolIndex<T> {
    public TarantoolIndexSync(TarantoolClient client, String spaceName, Class<T> type, String indexName, List<TarantoolSpace.Tuple> indexFields, Map<Integer, String> fields, IndexType indexType, boolean ifNotExists, boolean unique) {
