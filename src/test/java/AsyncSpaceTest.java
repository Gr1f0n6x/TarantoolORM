...
import org.tarantool.orm.TarantoolSpaceAsyncOps;
...
public class AsyncSpaceTest {
    ...
    private TarantoolSpaceAsyncOps<MyTuple> space;
    ...
    public void initClient() throws TarantoolORMException {
        ...
        this.space = ((TarantoolSpaceAsyncOps<MyTuple>)TarantoolSchema.createSpaceAsync(client, MyTuple.class, "my_space", true));
    ...
    @Test
    public void testInsert() throws TarantoolNoSuchIndexException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testSelect() throws TarantoolNoSuchIndexException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testDelete() throws TarantoolNoSuchIndexException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testUpdate() throws TarantoolNoSuchIndexException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testReplace() throws TarantoolNoSuchIndexException, ExecutionException, InterruptedException {
    ...
    @Test
    public void testUpsert() throws TarantoolNoSuchIndexException, ExecutionException, InterruptedException {
